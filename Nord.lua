...
function Nord:Notify(Title, Message, Type, Duration)
	...
	local Type2Color = {['error'] = Color3.fromRGB(255, 87, 87), ['warn'] = Color3.fromRGB(255, 255, 127), ['success'] = Color3.fromRGB(85, 255, 127), ['normal'] = Color3.fromRGB(255, 255, 255),['maxy'] = Color3.fromRGB(255, 1, 1)}
	...
	local Header = New("TextLabel", {Parent = Frame, BackgroundTransparency = 1, Position = UDim2.new(0.237, 0, 0.172, 0), Size = UDim2.new(0.4, 0, 0.358, 0), ZIndex = 2, Font = "GothamMedium",
		Text = Title or "MaxHub", TextSize = 13, TextXAlignment = "Left", TextScaled = true, TextColor3 = Color3.new(1, 1, 1)
